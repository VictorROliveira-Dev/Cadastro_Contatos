...
namespace AppWebMVC.Data
{
    ...
    {
        public static void Initialize(AppWebMVCContext context)
        {
            context.Database.EnsureCreated();
            //verificando a existencia dentro do banco de dados:
            ...
            Seller s2 = new Seller("Maria Green", "maria@gmail.com", 3500.0, new DateTime(1979, 12, 31), d2);
            ...
            context.Sellers.AddRange(s1, s2, s3, s4, s5, s6);
